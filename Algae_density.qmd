...
H0 = invertebrate count does not change with increasing algae cover.

HA = invertebrate count does change with increasing algae cover.
...
predict = predict(object = invert_model,
                           newdata = pred_grid,
                           type = "response")
...
Based on our model, we did not see a significant affect of algae coverage or elevation on invertebrate density. We did, however, see a significant affect of sample date and region on invertebrate density. We predict what's driving any patterns in invertebrate density is not algae coverage, but the day and region. This could be due to a few reasons.
